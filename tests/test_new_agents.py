...
class TestNewAgentsExist:
    ...
    def test_total_agent_count(self):
        """Total agent count is 27 (7 original + 4 Phase 9 + 8 Phase 11 + 7 Phase 12 + 1 sindri_admin)."""
        agents = list_agents()
...
class TestBrokkrDelegation:
    ...
    def test_brokkr_delegation_count(self):
        """Brokkr can delegate to 24 agents (5 original + 4 Phase 9 + 8 Phase 11 + 7 Phase 12)."""
        agent = get_agent("brokkr")
        assert len(agent.delegate_to) == 24
