...
AGENTS: dict[str, AgentDefinition] = {
    ...
    "brokkr": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "shell", "delegate", "propose_plan"],
        can_delegate=True,
    ...
    "huginn": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "shell", "delegate"],
        can_delegate=True,
    ...
    "mimir": AgentDefinition(
        ...
        tools=["read_file", "search_code", "shell"],
        can_delegate=False,
        estimated_vram_gb=5.0,
        priority=1,
        max_iterations=20,
    ...
    "odin": AgentDefinition(
        ...
        tools=["read_file", "search_code", "delegate"],
        can_delegate=True,
