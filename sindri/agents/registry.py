...
AGENTS: dict[str, AgentDefinition] = {
    ...
    "brokkr": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "shell", "delegate", "propose_plan"],
        can_delegate=True,
    ...
    "huginn": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "shell", "delegate"],
        can_delegate=True,
