...
AGENTS: dict[str, AgentDefinition] = {
    ...
    "brokkr": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "git_status", "git_diff", "git_log", "git_branch", "http_request", "run_tests", "check_syntax", "format_code", "lint_code", "rename_symbol", "extract_function", "inline_variable", "move_file", "batch_rename", "shell", "delegate", "propose_plan"],
        can_delegate=True,
    ...
    "huginn": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "git_status", "git_diff", "git_log", "http_request", "run_tests", "check_syntax", "format_code", "lint_code", "rename_symbol", "extract_function", "inline_variable", "move_file", "batch_rename", "shell", "delegate"],
        can_delegate=True,
