...
AGENTS: dict[str, AgentDefinition] = {
    ...
    "brokkr": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "git_status", "git_diff", "git_log", "git_branch", "http_request", "run_tests", "check_syntax", "shell", "delegate", "propose_plan"],
        can_delegate=True,
    ...
    "huginn": AgentDefinition(
        ...
        tools=["read_file", "write_file", "edit_file", "list_directory", "read_tree", "search_code", "find_symbol", "git_status", "git_diff", "git_log", "http_request", "run_tests", "check_syntax", "shell", "delegate"],
        can_delegate=True,
    ...
    "mimir": AgentDefinition(
        ...
        tools=["read_file", "search_code", "git_diff", "git_log", "run_tests", "check_syntax", "shell"],
        can_delegate=False,
        estimated_vram_gb=5.0,
        priority=1,
        max_iterations=20,
